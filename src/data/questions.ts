...
const type1Both: QuestionEntry[] = [
  ...
  },
  {
    ...
    mode: 'both',
    text: {
      en: 'I believe that living according to strong moral principles is essential to being a good person.',
      zh: '我认为，遵从坚定的道德原则是成为一个好人的根本所在。',
    },
    weight: { primary: 1.0 },
  },
  {
    ...
    mode: 'both',
    text: {
      en: 'I often notice flaws or errors that others seem to overlook.',
      zh: '我经常会注意到别人似乎忽视的缺陷或错误。',
    },
    weight: { primary: 1.0 },
  },
  {
...
const type2Full: QuestionEntry[] = [
  ...
  },
  {
    ...
    mode: 'full',
    text: {
      en: 'Being generous and giving comes naturally to me; I rarely feel I do too much for others.',
      zh: '慷慨付出对我来说是自然而然的事，我几乎不觉得自己为别人做得太多。',
    },
    weight: { primary: 1.0 },
  },
  {
...
const type3Full: QuestionEntry[] = [
  ...
  },
  {
    ...
    mode: 'full',
    text: {
      en: 'I thrive when I can set clear goals and track my progress toward them.',
      zh: '当我能够设定明确的目标并追踪自己的进展时，我会进入最佳状态。',
    },
    weight: { primary: 1.0 },
  },
  {
...
const type6Full: QuestionEntry[] = [
  ...
  },
  {
    ...
    mode: 'full',
    text: {
      en: 'I feel safer when I know the rules and expectations in any given situation.',
      zh: '当我了解某个情境中的规则和期望时，我会感到更安心。',
    },
    weight: { primary: 1.0 },
  },
  {
...
const type8Both: QuestionEntry[] = [
  ...
  },
  {
    ...
    mode: 'both',
    text: {
      en: 'I stand up for people who are unable to defend themselves against injustice.',
      zh: '对于那些无力抵抗不公的人，我会挺身而出，替他们发声。',
    },
    weight: { primary: 1.0 },
  },
  {
...
const type9Full: QuestionEntry[] = [
  ...
  },
  {
    ...
    mode: 'full',
    text: {
      en: 'I feel most at peace when everyone around me is comfortable and getting along.',
      zh: '当周围所有人都感到舒适、相处融洽时，我会感到最平静、最安心。',
    },
    weight: { primary: 1.0 },
  },
  {
